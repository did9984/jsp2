        ...
        <body cellpadding="0" cellspacing="0" marginleft="0" margintop="0" width="100%" height="100%" align="center">
            ...
            <div class="card align-middle" style="width:25rem;">
                <div class="card-title" style="margin-top:30px;">
                    ...
                    <br>
                    <span class="hangle" style="color:#f58b34; font:50px bold; font-family: 'Dongle', sans-serif;">비밀번호
                        찾기</span><br>
                    <span class="hangle" style="color:black; font-size:30px; font-family: 'Dongle', sans-serif;">
                        회원님의 아이디는 ${fvo.userId} 입니다</span><br>
                    <span class="hangle" style="color:black; font-size:30px; font-family: 'Dongle', sans-serif;">
                        회원님의 비밀번호는 ${fvo.userPw} 입니다</span>
                </div>

                <div class="card-body form-floating">
                    <form action="login.do" class="form-signin" method="POST">
                        <button id="btn_yes" class="btn btn-lg btn-warning btn-block" type="submit">로그인하러 가기</button>
                    </form>
