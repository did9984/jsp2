...
<link rel="stylesheet" type="text/css" href="bootstrap/css/mypage_style.css">
	...
	<tr>
		...
		<form name="reviewReadFrm" method="post" action="">
			...
			<h3 class="inner_title" id="review_inner_title">고객들이 작성한 리뷰</h3>
	...
	<table class="horHead review_table" id="review_read_tb">
		...
		<div class="list-page text-center">
			<ul class="pagination pagination-sm en">
									...
									<li>
										<a href="/bbs/board.php?bo_table=gametalk&amp;page=5">5</a>
									</li>
									<li>
										<a href="/bbs/board.php?bo_table=gametalk&amp;page=6">6</a>
									</li>
									<li>
										<a href="/bbs/board.php?bo_table=gametalk&amp;page=7">7</a>
									</li>
									<li>
										<a href="/bbs/board.php?bo_table=gametalk&amp;page=8">8</a>
									</li>
									<li>
										<a href="/bbs/board.php?bo_table=gametalk&amp;page=9">9</a>
									</li>
									<li>
										<a href="/bbs/board.php?bo_table=gametalk&amp;page=10">10</a>
									</li>
									<li>
										<a href="/bbs/board.php?bo_table=gametalk&amp;page=11">
									...
									<li>
										<a href="/bbs/board.php?bo_table=gametalk&amp;page=4311">
