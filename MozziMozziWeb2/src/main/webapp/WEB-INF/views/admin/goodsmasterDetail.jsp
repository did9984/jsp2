				...
				<form name="orderFrm" method="post" action="#">
					...
					<section id="order_private">
						...
						<div class="order_btn_wrapper">
							<input type="button" class="btn order_submit" onclick="location.href='orderList.do?id=${logId}'" value="배송완료">
							<input type="button" class="btn order_submit" onclick="location.href='main.do'" value="주문취소">
						</div>
					</section>
				</form>
			</div>
